...
export default function App() {
  ...
  const searchClicked = () => {
    ...
    const nodeTerjemahan = selectValue === 'id_en' ? rbtId.find(inputValue.toLowerCase()) : rbtEn.find(inputValue.toLowerCase());
    if (nodeTerjemahan) {
  ...
  return (
    ...
    >
      ...
      <ResultBox result={terjemahan} example={example} isError={isError} />
    </div>
  );
}
